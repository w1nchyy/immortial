...
Section:NewButton("KingHUB", "Loading KingHUB to you'r game", function()
    loadstring(game:HttpGet(('https://pastebin.com/raw/R8QMbhzv')))()
end)
Section:NewButton("KingHUB V2", "Loading KingHUB to you'r game", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/KINGHUB01/KING-HUB-NO-1/main/kingshubno1"))()
end)
Section:NewButton("PoopDoors", "Loading PoopDoors to you'r game", function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/mstudio45/poopdoors_edited/main/poopdoors_edited.lua"),true))() 
end)
Section:NewButton("SasWare", "Loading SasWare to you'r game", function()
    loadstring(game:HttpGet('https://scripts.luawl.com/16284/doorsScript.lua'))()
end)
Section:NewButton("Zoop", "Loading Zoop to you'r game", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/zoophiliaphobic/POOPDOORS/main/script.lua'))() 
end)
Section:NewButton("Chiba", "Loading Chiba to you'r game", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/KindIhave/ChibaHubcomeback/main/Chiba-Doors.txt'))()
end)
Section:NewButton("Auto Skip Door", "Skiping doors(H to use)", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/w1nchyy/scripts/main/doors-skip'))()
end)

local Section = Tab:NewSection("Rooms Scripts")
Section:NewButton("Auto Walk", "Pathfinding to A-1000", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/DaRealGeo/roblox/master/rooms-autowalk'))()
end)
Section:NewButton("Notifier", "Notify you if A-60 if A-120 running", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/w1nchyy/scripts/main/rooms-notifier'))()
end)
Section:NewButton("Crimson", "Loading Crimson in you'r game", function()
